...
- `tests/test_train_policy.py`, `test_evaluate.py`, `test_build_development_baselines.py`, `test_development_evidence.py`, `test_headroom.py`, `test_run_oracle_study.py`, `test_publish_oracle_study.py`, `test_oracle_distilled_ppo_evidence.py`, `test_network_capacity_evidence.py`, `test_moderate_family_training.py`, `test_moderate_family_evidence.py`, and `test_publish_final_evaluation_v4.py` cover the scientific tools and their current plus historical evidence.
